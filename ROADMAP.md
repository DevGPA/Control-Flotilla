...
| Fase 3 — Taller completo | 🟢 renderActivas ✅ + renderHistorial ✅ (2026-04-20), KPI/donut en legado | `src/taller/tallerStore.ts` + `renderActivas.ts` + `renderHistorial.ts` + 93 tests |
