...
| **`damage_list`/golpes** _(condicional)_              | Solo se conservan las keys de foto; metadatos se aplanan a "Foto daño" — **pero no se verificó que Ops mande metadatos**                                         | `answers.golpes` (forma no confirmada) | Bajo     | Confirmar la forma real contra el 1er mensual con daños antes de actuar                                                |
